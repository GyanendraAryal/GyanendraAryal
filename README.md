...
💼 Featured Projects
Full-stack MERN platform with booking/inquiry system and condition-based product filtering

JWT-secured admin dashboard with complete CRUD operations

Versioned API architecture integrated with scalable MongoDB schemas

📈 Currently Building
Robust system design and backend scalability
